...
SUPPORTED_MODEL_CONFIGS = {
    ModelType.COGVIDEOX: {
        ...
        InferenceType.MOT: CogVideoXModelSpecification,
    },
    ModelType.COGVIEW4: {
    ...
    ModelType.WAN: {
        ...
        InferenceType.MOT: WanModelSpecification,
    },
}
...
class Inference:
    ...
    def _init_trackers(self) -> None:
        ...
        runs_name = self.args.runs_name or "finetrainers-runs"
        self.state.parallel_backend.initialize_trackers(
            trackers, experiment_name=experiment_name, config=self.args.to_dict(), log_dir=self.args.logging_dir, runs_name=runs_name
        )
...
class MiscellaneousArgs(ArgsConfigMixin):
    ...
    def add_args(self, parser: argparse.ArgumentParser) -> None:
        ...
        parser.add_argument("--runs_name", type=str, default="finetrainers")
    ...
    def map_args(self, argparse_args: argparse.Namespace, mapped_args: "BaseArgs"):
        ...
        mapped_args.runs_name = argparse_args.runs_name
...
class VideoAnimatorArgs(ArgsConfigMixin):
    r"""
    ...
    def add_args(self, parser: argparse.ArgumentParser):
        ...
        # mot
        parser.add_argument(
            "--videoanimator_mot_name_or_path",
            type=str,
            default=None,
        ...
        parser.add_argument(
            ...
            type=str,
            default="examples/training/sft/cogvideox/vfx_mot/config_ori.json",
        ...
        parser.add_argument(
            "--training_type", type=str, default="none"
        )
    ...
    def map_args(self, argparse_args: argparse.Namespace, mapped_args: "BaseArgs"):
        ...
        # mot
        mapped_args.videoanimator_mot_name_or_path = argparse_args.videoanimator_mot_name_or_path
        ...
        mapped_args.training_type = argparse_args.training_type
...
class BaseArgs:
    ...
    video_animator_args = VideoAnimatorArgs()
    ...
    def __init__(self):
        self._arg_group_map: Dict[str, ArgsConfigMixin] = {
            ...
            "video_animator_args": self.video_animator_args,
        }
