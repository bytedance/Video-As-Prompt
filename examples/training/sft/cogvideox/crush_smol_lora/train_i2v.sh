...
VALIDATION_DATASET_FILE="examples/training/sft/cogvideox/crush_smol_lora/validation_i2v.json"
...
miscellaneous_cmd=(
  ...
  --output_dir "outputs/2000-cogvideox-i2v-crush-smol-lora"
  --runs_name "2000-cogvideox-i2v-crush-smol-lora"
  --init_timeout 600
  --nccl_timeout 600
  --report_to "wandb"
)
