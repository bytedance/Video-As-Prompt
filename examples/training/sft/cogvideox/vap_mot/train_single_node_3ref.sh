...
TRAINING_DATASET_CONFIG="examples/training/sft/cogvideox/vap_mot/training_hq.json"
VALIDATION_DATASET_FILE="examples/training/sft/cogvideox/vap_mot/validation_i2v_3ref_1_hq.json"
...
video_animator_cmd=(
  --ref_videos_num 10
  --sample_ref_videos_num 3
  --mask_ref_ratio 0.3
  --mask_caption_ratio 0.1
...
miscellaneous_cmd=(
  ...
  --output_dir "outputs/train_multi_node_3ref_alignment>10"
  --runs_name "train_multi_node_3ref_alignment>10"
  --init_timeout 3600
  --nccl_timeout 3600
  --report_to "wandb"
)
