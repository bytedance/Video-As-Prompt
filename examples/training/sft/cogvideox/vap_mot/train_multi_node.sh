...
DDP_48="--parallel_backend $BACKEND --pp_degree 1 --dp_degree 48 --dp_shards 1 --cp_degree 1 --tp_degree 1"
...
miscellaneous_cmd=(
  ...
  --output_dir "outputs/train_multi_node_alignment>10"
  --runs_name "train_multi_node_alignment>10"
  --init_timeout 3600
  --nccl_timeout 3600
  --report_to "wandb"
)
