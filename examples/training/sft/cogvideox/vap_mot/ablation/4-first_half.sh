...
video_animator_cmd=(
  ...
  --model_structure_config "examples/training/sft/cogvideox/vap_mot/ablation/config_ori_first_half.json"
)
...
miscellaneous_cmd=(
  ...
  --output_dir "outputs/ablation_cog_first_half"
  --runs_name "ablation_cog_first_half"
  --init_timeout 3600
  --nccl_timeout 3600
  --report_to "wandb"
)
