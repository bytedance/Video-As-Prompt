...
video_animator_cmd=(
  ...
  --model_structure_config "examples/training/sft/cogvideox/vap_mot/ablation/config_ori_distributed_first_half.json"
)
...
training_cmd=(
  --training_type "videoanimator-mot"
  --seed 42
  --batch_size 1
  --train_steps 60000
  --target_modules "none"
...
miscellaneous_cmd=(
  ...
  --output_dir "outputs/ablation_cog_distributed_first_half"
  --runs_name "ablation_cog_distributed_first_half"
  --init_timeout 3600
  --nccl_timeout 3600
  --report_to "wandb"
)
