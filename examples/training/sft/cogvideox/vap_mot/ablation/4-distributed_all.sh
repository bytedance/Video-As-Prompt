...
video_animator_cmd=(
  ...
  --model_structure_config "examples/training/sft/cogvideox/vap_mot/ablation/config_ori_distributed_all.json"
)
...
miscellaneous_cmd=(
  ...
  --output_dir "outputs/ablation_cog_distributed_all"
  --runs_name "ablation_cog_distributed_all"
  --init_timeout 3600
  --nccl_timeout 3600
  --report_to "wandb"
)
