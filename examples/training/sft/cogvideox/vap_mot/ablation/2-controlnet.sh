...
video_animator_cmd=(
  ...
  --model_structure_config "examples/training/sft/cogvideox/vfx_mot/config_ori.json"
...
miscellaneous_cmd=(
  ...
  --output_dir "outputs/ablation_cog_residual_addition"
  --runs_name "ablation_cog_residual_addition"
  --init_timeout 3600
  --nccl_timeout 3600
  --report_to "wandb"
)
