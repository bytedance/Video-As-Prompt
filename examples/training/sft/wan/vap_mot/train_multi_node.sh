...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/vap_mot/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/vap_mot/validation.json"
...
HSDP_2_4="--parallel_backend $BACKEND --pp_degree 1 --dp_degree 2 --dp_shards 4 --cp_degree 1 --tp_degree 1"

HSDP_8_4="--parallel_backend $BACKEND --pp_degree 1 --dp_degree 8 --dp_shards 4 --cp_degree 1 --tp_degree 1"
HSDP_12_2="--parallel_backend $BACKEND --pp_degree 1 --dp_degree 12 --dp_shards 2 --cp_degree 1 --tp_degree 1"
HSDP_16_2="--parallel_backend $BACKEND --pp_degree 1 --dp_degree 16 --dp_shards 2 --cp_degree 1 --tp_degree 1"
HSDP_24_2="--parallel_backend $BACKEND --pp_degree 1 --dp_degree 24 --dp_shards 2 --cp_degree 1 --tp_degree 1"

HSDP_4_2_4="--parallel_backend $BACKEND --pp_degree 1 --dp_degree 4 --dp_shards 2 --cp_degree 4 --tp_degree 1"
HSDP_8_2_2="--parallel_backend $BACKEND --pp_degree 1 --dp_degree 8 --dp_shards 2 --cp_degree 2 --tp_degree 1"
...
model_cmd=(
  --model_name "wan"
  --pretrained_model_name_or_path "ckpts/Wan2.1-I2V-14B-480P-Diffusers"
)
...
video_animator_cmd=(
  ...
  --model_structure_config "examples/training/sft/wan/vap_mot/config_ori_d_10.json"
  --alignment_score_threshold 10
  # --attn_provider_training "transformer:_native_flash"
  # --attn_provider_inference "transformer:_native_flash"
)
...
miscellaneous_cmd=(
  --tracker_name "VideoAnimator"
  --output_dir "outputs/train_multi_node_alignment_10"
  --runs_name "train_multi_node_alignment_10"
  --init_timeout 3600
  --nccl_timeout 3600
  --report_to "wandb"
)
