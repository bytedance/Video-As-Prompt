...
HSDP_T_1_4_2="--parallel_backend $BACKEND --pp_degree 1 --dp_degree 1 --dp_shards 4 --cp_degree 1 --tp_degree 2"
HSDP_T_1_2_4="--parallel_backend $BACKEND --pp_degree 1 --dp_degree 1 --dp_shards 2 --cp_degree 1 --tp_degree 4"
HSDP_C_1_2_4="--parallel_backend $BACKEND --pp_degree 1 --dp_degree 1 --dp_shards 2 --cp_degree 4 --tp_degree 1"
HSDP_C_2_2_2="--parallel_backend $BACKEND --pp_degree 1 --dp_degree 2 --dp_shards 2 --cp_degree 2 --tp_degree 1"
# Parallel arguments
parallel_cmd=(
  $HSDP_2_4
)
...
video_animator_cmd=(
  ...
  --training_dataset_kind "openvfx"
  --model_structure_config "examples/training/sft/wan/vap_mot/config_ori_d_20.json"
...
miscellaneous_cmd=(
  ...
  --output_dir "outputs/train_single_node_wan"
  --runs_name "train_single_node_wan"
  --init_timeout 3600
  --nccl_timeout 3600
  --report_to "wandb"
)
