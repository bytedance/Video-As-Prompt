...
class WandbTracker(BaseTracker):
    ...
    def __init__(self, experiment_name: str, log_dir: str, config: Optional[Dict[str, Any]] = None, runs_name: Optional[str] = None) -> None:
        super().__init__()
        ...
        self.run = wandb.init(project=experiment_name, dir=log_dir, config=config, name=runs_name)
...
def initialize_trackers(
    trackers: List[str], experiment_name: str, config: Dict[str, Any], log_dir: str, runs_name: str
    ...
    for tracker_name in set(trackers):
        if tracker_name == Trackers.NONE:
            ...
            tracker = WandbTracker(experiment_name, log_dir, config, runs_name)
