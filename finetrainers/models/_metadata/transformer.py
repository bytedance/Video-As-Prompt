...
def register_transformer_metadata():
    ...
    # CogVideoX-MOT
    TransformerRegistry.register(
        model_class=CogVideoXTransformer3DMOTModel,
        metadata=TransformerMetadata(
            cp_plan={
                "": {
                    ParamId("image_rotary_emb", 5): [CPInput(0, 2), CPInput(0, 2)],
                    ParamId("image_rotary_emb_mot_ref", 5): [CPInput(0, 2), CPInput(0, 2)],
                },
                "transformer_blocks.0": {
                    ParamId("hidden_states", 0): CPInput(1, 3),
                    ParamId("encoder_hidden_states", 1): CPInput(1, 3),
                    ParamId("hidden_states_mot_ref", 2): CPInput(1, 3),
                    ParamId("encoder_hidden_states_mot_ref", 3): CPInput(1, 3),
                },
                "proj_out": [CPOutput(1, 3)],
            }
        ),
    ...
    TransformerRegistry.register(
        model_class=WanTransformer3DMOTModel,
        metadata=TransformerMetadata(
            cp_plan={
                "rope": {
                    ParamId(index=0): CPInput(2, 4, split_output=True),
                ...
                "blocks.0": {
                    ParamId("hidden_states", 0): CPInput(1, 3),
                    ParamId("hidden_states_mot_ref", 0): CPInput(1, 3),
                },
                "proj_out": [CPOutput(1, 3)],
            }
        ),
