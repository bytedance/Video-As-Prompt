...
class BaseArgs:
    ...
    runs_name (`str`, defaults to `finetrainers`):
        Name of the runs to use for logging training metrics.
...
def _map_to_args_type(args: Dict[str, Any]) -> BaseArgs:
    ...
    result_args.runs_name = args.runs_name
